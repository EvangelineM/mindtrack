window.onload = function() {
    ...
    function drawFrame() {
        ...
        // Draw title centered in the header
        context.fillStyle = "#ffffff";
        context.font = "32px Arial";
        
        // Calculate the width of the text and center it horizontally
        var titleText = "Bubble Shooter Game";
        var textWidth = context.measureText(titleText).width;
        var xPosition = (canvas.width - textWidth) / 2;  // Center align horizontally
        
        // Calculate the vertical position to center the text in the header
        var textHeight = 32;  // The height of the text (since font size is 32px)
        var yPosition = (79 + textHeight) / 2;  // Center align vertically
    
        // Draw the text
        context.fillText(titleText, xPosition, yPosition);
    }
